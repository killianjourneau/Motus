  ...
  zones: [
    ...
    { id:"grotte", nom:"Les ruines de la Bibliothèque oubliée", e:"🕯️", mod:"echoZ2", lens:[5,6],
      ...
      etages:4,
                  monstres:[
        {n:"Souris savante",e:"🐭",
         cri:"C'est un vrai rat de bibliothèque. Montre-lui ce qu'elle aime et elle te laissera tranquille.",
         pouvoir:{id:"insignifiant",n:"Insignifiante",d:"Si petite qu'on n'a que quatre tentatives pour la viser."},
         cache:"livre"},
        {n:"Chauve-souris",e:"🦇",
         cri:"Je suis la vengeance. Je suis la nuit. Je suis… perdue si tout se brouille.",
         pouvoir:{id:"echoloc",n:"Écholocalisation",d:"Chaque lettre mal placée te coûte un point de vie."},
         cache:"toutjaune"},
        {n:"Cendre vivante",e:"🌫️",
         ...
         cache:"eau"},
        {n:"Ver de papier",e:"🪱",
         cri:"C'est un très gros ver ! Il siffle plus qu'il ne parle.",
         pouvoir:{id:"devoreur",n:"Dévoreur",d:"À chaque riposte, il dévore une lettre que tu avais trouvée."},
         cache:"sifflement"},
        {n:"Golem de pierre",e:"🗿",
         cri:"Une statue gardienne des lieux — il fallait qu'elle s'active maintenant. Elle ne voit que ce qui bouge.",
         pouvoir:{id:"durpierre",n:"Dur comme la pierre",d:"Les dégâts bonus glissent sur lui : seules les lettres comptent."},
         cache:"immobile"}
      ],
                  elites:[
        {n:"Esprit de bibliothécaire",e:"👤",
         cri:"TAISEZ-VOUS. Ici, on ne prononce aucune formule.",
         pouvoir:{id:"interdit",n:"Silence absolu",d:"Aucune compétence ne peut être employée."},
         cache:"livre"},
        {n:"Ombre menaçante",e:"🕳️",
         cri:"Discrète comme une ombre. Elle guette ce que tu lui donnes.",
         pouvoir:{id:"fond",n:"Menace grandissante",d:"Chaque tentative ratée la rend plus dangereuse."},
         cache:"maindue"}
      ],
